<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Presentacion.InicioTecnico" %>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="agregarEmpresa.html">Añadir empresa</a>
                                </li>
                                <li>
                                     <a href="listaEmpresas.html">Lista empresas</a>
                                </li>
                            </ul>
                    </li>
                    <li>
                            <a href="#"><i class="glyphicon glyphicon-list-alt"></i> Tipos de evaluación<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Evaluación de personal</a>
                                </li>
                                <li>
                                     <a href="">Evaluación instalaciones</a>
                                </li>
                            </ul>
                    </li>
