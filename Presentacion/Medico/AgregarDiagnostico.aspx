<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarDiagnostico.aspx.cs" Inherits="Presentacion.Medico.AgregarEvaluacion" %>
...
<head runat="server">
    ...
    <title>Sistema - Agregar Diagnostico</title>
    <!-- Bootstrap Styles-->
                 ...
                 <div class="row">
                        ...
                        <div class="col-lg-6">                          
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="cmbCita" runat="server" class="form-control" OnDataBound="cmbCita_DataBound">
                                               </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
